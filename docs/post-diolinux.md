...
Foi daí que comecei a montar o **QuickDeck**: a ideia é usar o celular como um painel de atalhos pro computador, meio como um Stream Deck, mas sem precisar comprar outro dispositivo.
